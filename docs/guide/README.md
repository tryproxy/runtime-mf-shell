...
| [Starter style guide](https://github.com/tryproxy/runtime-mf-react-remote-starter/blob/1a1498e/docs/style-guide.md) | Remote visual/ownership rules (starter commit `1a1498e`). Shell Lab at `/host/style-guide` is the Shell-owned chrome lab, not a copy of that guide. |
