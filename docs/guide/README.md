...
**New React remote:** copy tag
[`v0.1.0`](https://github.com/tryproxy/runtime-mf-react-remote-starter/tree/v0.1.0)
(not `main`) and follow
[its README](https://github.com/tryproxy/runtime-mf-react-remote-starter/blob/v0.1.0/README.md)
...
| [Starter style guide](https://github.com/tryproxy/runtime-mf-react-remote-starter/blob/v0.1.0/docs/style-guide.md) | Maintained remote visual/ownership rules. Shell Lab at `/host/style-guide` is the Shell-owned chrome lab, not a copy of that guide. |
...
- React starter (greenfield React remote): [tryproxy/runtime-mf-react-remote-starter](https://github.com/tryproxy/runtime-mf-react-remote-starter/tree/v0.1.0) (`v0.1.0`)
