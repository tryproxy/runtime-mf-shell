...
import { AppPageTabs } from '@/app/shell/app-page-tabs';
import { ShellAccountFooter } from '@/app/shell/shell-account-footer';
import { ShellHeaderProfile } from '@/app/shell/shell-header-profile';
import { ShellMobileBar } from '@/app/shell/shell-mobile-bar';
import { logoutSession } from '@/shared/auth';
...
export function AppShell({
  ...
  return (
    <div className="bg-background text-foreground grid h-svh grid-cols-1 grid-rows-[auto_minmax(0,1fr)_auto] overflow-hidden md:grid-cols-[15rem_minmax(0,1fr)] md:grid-rows-[auto_minmax(0,1fr)]">
      ...
      <main className="bg-background min-h-0 min-w-0 overflow-x-auto overflow-y-auto p-0 md:col-start-2 md:row-start-2">
        {children}
      </main>
