export const ru = {
  ...
  nav: {
    ...
    asoDesc: 'Продуктовое приложение, подключённое к этому шеллу.',
    zeywin: 'Zeywin',
    zeywinDesc: 'Продуктовое приложение, подключённое к этому шеллу.',
    pageHome: 'Главная',
    pageOverview: 'Обзор',
  ...
  auth: {
    ...
    asoTokenSubmit: 'Войти по access token',
